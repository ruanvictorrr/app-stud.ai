...
"[project]/.next-internal/server/app/api/auth/reset/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/auth/reset/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const vt = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].verificationToken.findUnique({
            where: {
                token
            }
        });
        ...
        // remove token usado + quaisquer outros do email
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].verificationToken.deleteMany({
            where: {
                identifier: email
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3eef05a9._.js.map