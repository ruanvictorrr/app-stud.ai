...
async function POST(req) {
    try {
        ...
        // 1️⃣ Busca token
        const resetToken = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].passwordResetToken.findUnique({
            where: {
                token
            },
            include: {
        ...
        if (resetToken.expiresAt < new Date()) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].passwordResetToken.delete({
                where: {
                    token
                }
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cd01e7f8._.js.map