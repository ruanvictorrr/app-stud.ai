...
async function POST(req) {
    ...
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].passwordResetToken.deleteMany({
            where: {
                userId: user.id
            }
        });
        ...
        const origin = ("TURBOPACK compile-time value", "http://localhost:3000")?.trim() || req.nextUrl.origin || "http://localhost:3000";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__99e870cd._.js.map