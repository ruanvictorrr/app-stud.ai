...
function ResetPasswordPage() {
    ...
    const canSubmit = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ResetPasswordPage.useMemo[canSubmit]": ()=>{
    ...
    async function onSubmit(e) {
        ...
        try {
            ...
            if (!res.ok || (json === null || json === void 0 ? void 0 : json.success) === false) {
                throw new Error((json === null || json === void 0 ? void 0 : json.error) || (json === null || json === void 0 ? void 0 : json.details) || "Não foi possível redefinir sua senha.");
            }
            setOk(true);
...
_s(ResetPasswordPage, "t9SW6ONDCYwuhjwMRQyFGwYZyMY=", false, function() {
    return [
...
//# sourceMappingURL=_38dd8a07._.js.map