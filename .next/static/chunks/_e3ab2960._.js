...
function LoginPage() {
    ...
    const [forgotMsg, setForgotMsg] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
            ...
            ({
                "LoginPage.useEffect": async ()=>{
                    try {
                        ...
                        if ((json === null || json === void 0 ? void 0 : json.success) && (json === null || json === void 0 ? void 0 : json.user)) {
    ...
    async function onLogin(e) {
        ...
        try {
            ...
            if (!res.ok || !(json === null || json === void 0 ? void 0 : json.success)) {
                throw new Error((json === null || json === void 0 ? void 0 : json.error) || "Falha ao fazer login.");
            }
            setMsg(null);
            window.location.href = "/";
        } catch (err) {
            setMsg((err === null || err === void 0 ? void 0 : err.message) || "Erro inesperado.");
        } finally{
            setLoading(false);
        }
    }
    ...
    async function onForgot(e) {
        ...
        try {
            ...
            const json = await res.json().catch(()=>null);
            if (!res.ok || (json === null || json === void 0 ? void 0 : json.success) === false) {
                throw new Error((json === null || json === void 0 ? void 0 : json.error) || "Não foi possível enviar o link.");
            }
            // ✅ por segurança o endpoint retorna success mesmo se não existir
            setForgotMsg("Se o email estiver cadastrado, você verá o link no terminal (por enquanto).");
        } catch (err) {
            setForgotMsg((err === null || err === void 0 ? void 0 : err.message) || "Erro inesperado.");
        } finally{
        ...
        children: [
            ...
            forgotOpen ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "relative w-full max-w-md bg-[#121212] rounded-2xl p-6 shadow-xl border border-white/5",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: "Informe seu email para gerar o link de redefinição."
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/login/page.tsx",
                                                lineNumber: 194,
                                                columnNumber: 17
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                                ...
                                children: [
                                    ...
                                    forgotMsg ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: cn("text-sm rounded-lg px-3 py-2 border", forgotMsg.includes("Se o email") ? "text-emerald-300 bg-emerald-500/10 border-emerald-500/20" : "text-red-400 bg-red-500/10 border-red-500/20"),
                                        children: forgotMsg
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/login/page.tsx",
                                        lineNumber: 219,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: cn("w-full h-11 rounded-lg font-medium transition", "bg-[#00FF8B] text-black hover:opacity-90", forgotLoading && "opacity-60 cursor-not-allowed"),
                                        children: forgotLoading ? "Enviando..." : "Enviar link"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/login/page.tsx",
                                        lineNumber: 231,
                                        columnNumber: 15
...
_s(LoginPage, "7Tqfh8JQuxDTDe/F/5i54vn3wgM=");
_c = LoginPage;
var _c;
